    ...
    return (
        <div className="bg-[#070b19] pt-16 mt-10">
            <div className="flex justify-center items-center flex-col space-y-4">
                ...
                A landing page can enhance the user experience of your digital marketing campaign to 100%. We at Outrank help businesses create their identity through their landing page to Outrank.</p>
            </div>
